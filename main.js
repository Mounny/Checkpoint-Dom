// Declaration
var favs = Array.from(document.querySelectorAll(".likebtn"));
var deleteBtns = Array.from(document.querySelectorAll(".delete"));
var cards = Array.from(document.querySelectorAll(".card"));
var plusBtns = Array.from(document.querySelectorAll(".add"));
var minusBtns = Array.from(document.querySelectorAll(".minus"));
